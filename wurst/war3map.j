...
//===========================================================================
// 
// Ultimate Sheep Tag Fixus 1.13
// 
//   Warcraft III map script
//   Generated by the Warcraft III World Editor
//   Date: Sat Dec 29 18:03:36 2018
//   Map Author: Chakra
// 
//===========================================================================
    ...
    elseif gameState == "start" then
        ...
        loop
            ...
            if IsPlayerInForce(Player(i), wolfTeam) and GetPlayerSlotState(Player(i)) != PLAYER_SLOT_STATE_EMPTY then
                ...
                //call UnitAddItem(wolves[i], CreateItem(wolf.itemGlobal, GetStartLocationX(i), GetStartLocationY(i)))
                if countHere(wolfTeam) == 1 then
                    //call UnitAddItem(wolves[i], CreateItem(wolf.item1, GetStartLocationX(i), GetStartLocationY(i)))
                elseif countHere(wolfTeam) == 2 then
                    //call UnitAddItem(wolves[i], CreateItem(wolf.item2, GetStartLocationX(i), GetStartLocationY(i)))
                elseif countHere(wolfTeam) == 3 then
                    //call UnitAddItem(wolves[i], CreateItem(wolf.item3, GetStartLocationX(i), GetStartLocationY(i)))
                elseif countHere(wolfTeam) == 4 then
                    //call UnitAddItem(wolves[i], CreateItem(wolf.item4, GetStartLocationX(i), GetStartLocationY(i)))
                endif
                if GetLocalPlayer() == Player(i) then
                    call ClearSelection()
...
function Trig_sheepSaveDeath_Actions takes nothing returns nothing
    ...
    if GetUnitTypeId(GetTriggerUnit()) == s__sheep_type or GetUnitTypeId(GetTriggerUnit()) == s__sheep_blacktype or GetUnitTypeId(GetTriggerUnit()) == s__sheep_silvertype or GetUnitTypeId(GetTriggerUnit()) == s__sheep_goldtype then
        ...
        if saveskills[GetPlayerId(GetOwningPlayer(GetKillingUnit()))] == 10 or saveskills[GetPlayerId(GetOwningPlayer(GetKillingUnit()))] == 40 then
    ...
    elseif ( GetUnitTypeId(GetTriggerUnit()) == s__wolf_type or GetUnitTypeId(GetTriggerUnit()) == s__wolf_blacktype or GetUnitTypeId(GetTriggerUnit()) == s__wolf_imbatype ) and IsUnitAlly(GetKillingUnit(), GetOwningPlayer(GetTriggerUnit())) == false then
...
call ExecuteFunc("jasshelper__initstructs264433875")
...
function jasshelper__initstructs264433875 takes nothing returns nothing
